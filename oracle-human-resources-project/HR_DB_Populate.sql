...
select 'countries' as tablename, count(*) from countries union
select 'departments' as tablename, count(*) from departments union
select 'employees ' as tablename, count(*) from employees union
select 'job_history' as tablename,count(*) from job_history union
select 'jobs' as tablename, count(*) from jobs union
select 'locations' as tablename, count(*) from locations union
select 'regions' as tablename, count(*) from regions;